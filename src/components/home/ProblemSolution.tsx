      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-6 items-stretch">
          ...
          <motion.div
            ...
            className="group relative p-8 md:p-12 rounded-3xl bg-white/[0.02] border border-white/5 flex flex-col justify-between"
          >
            <div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-300 leading-relaxed font-light mb-6">
                We provide the intelligent software layer that sits at the core of your operations.
              </p>
              <p className="text-lg text-brand-cyan/90 leading-relaxed font-medium">
                We transform messy telecom logistics into a streamlined, profitable, and highly reliable messaging highway.
              </p>
            </div>
          </motion.div>
