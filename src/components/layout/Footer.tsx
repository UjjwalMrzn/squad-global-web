  ...
  return (
    <footer className="relative bg-black pt-24 pb-12 overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              {/* FIXED: Added aria-label to social links */}
              <a href="#" aria-label="LinkedIn Profile" className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-brand-cyan hover:border-brand-cyan/30 hover:bg-brand-cyan/5 transition-all">
                <Linkedin size={20} />
              </a>
              <a href="#" aria-label="Twitter Profile" className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-brand-cyan hover:border-brand-cyan/30 hover:bg-brand-cyan/5 transition-all">
                <Twitter size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 text-base text-gray-400 font-normal">
              ...
              <span>Squad Global LLC, Shams Media City, Al Messaned, Al Bataeh, Sharjah, United Arab Emirates</span>
            </div>
            <div className="flex items-start gap-3 text-base text-gray-400 font-normal">
        ...
        {/* FIXED: Changed text-gray-500 to text-gray-400 for contrast */}
